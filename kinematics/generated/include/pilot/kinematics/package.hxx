...
extern const vnx::TypeCode* const vnx_native_type_code_steering_drive_t; ///< \private
...
void read(TypeInput& in, ::pilot::kinematics::steering_drive_t& value, const TypeCode* type_code, const uint16_t* code); ///< \private
...
void write(TypeOutput& out, const ::pilot::kinematics::steering_drive_t& value, const TypeCode* type_code, const uint16_t* code); ///< \private
...
void read(std::istream& in, ::pilot::kinematics::steering_drive_t& value); ///< \private
...
void write(std::ostream& out, const ::pilot::kinematics::steering_drive_t& value); ///< \private
...
void accept(Visitor& visitor, const ::pilot::kinematics::steering_drive_t& value); ///< \private
...
/// \private
template<>
struct type<::pilot::kinematics::steering_drive_t> {
	...
	void create_dynamic_code(std::vector<uint16_t>& code);
	void create_dynamic_code(std::vector<uint16_t>& code, const ::pilot::kinematics::steering_drive_t& value, bool special = false);
};
