...
const vnx::Hash64 Velocity4::VNX_TYPE_HASH(0x8bb69c60caf044a2ull);
const vnx::Hash64 Velocity4::VNX_CODE_HASH(0x6293cb42d0409017ull);

vnx::Hash64 Velocity4::get_type_hash() const {
	return VNX_TYPE_HASH;
}

std::string Velocity4::get_type_name() const {
	return "pilot.kinematics.Velocity4";
}

const vnx::TypeCode* Velocity4::get_type_code() const {
	return pilot::kinematics::vnx_native_type_code_Velocity4;
}

std::shared_ptr<Velocity4> Velocity4::create() {
	return std::make_shared<Velocity4>();
}

std::shared_ptr<vnx::Value> Velocity4::clone() const {
	return std::make_shared<Velocity4>(*this);
}

void Velocity4::read(vnx::TypeInput& _in, const vnx::TypeCode* _type_code, const uint16_t* _code) {
	vnx::read(_in, *this, _type_code, _code);
}

void Velocity4::write(vnx::TypeOutput& _out, const vnx::TypeCode* _type_code, const uint16_t* _code) const {
	vnx::write(_out, *this, _type_code, _code);
}

void Velocity4::accept(vnx::Visitor& _visitor) const {
	const vnx::TypeCode* _type_code = pilot::kinematics::vnx_native_type_code_Velocity4;
...
void Velocity4::write(std::ostream& _out) const {
	_out << "{\"__type\": \"pilot.kinematics.Velocity4\"";
...
void Velocity4::read(std::istream& _in) {
	if(auto _json = vnx::read_json(_in)) {
		from_object(_json->to_object());
	}
}

vnx::Object Velocity4::to_object() const {
	vnx::Object _object;
	_object["__type"] = "pilot.kinematics.Velocity4";
...
void Velocity4::from_object(const vnx::Object& _object) {
...
vnx::Variant Velocity4::get_field(const std::string& _name) const {
	if(_name == "front_left") {
...
void Velocity4::set_field(const std::string& _name, const vnx::Variant& _value) {
	if(_name == "front_left") {
...
/// \private
std::ostream& operator<<(std::ostream& _out, const Velocity4& _value) {
	_value.write(_out);
	return _out;
}

/// \private
std::istream& operator>>(std::istream& _in, Velocity4& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* Velocity4::static_get_type_code() {
...
std::shared_ptr<vnx::TypeCode> Velocity4::static_create_type_code() {
	auto type_code = std::make_shared<vnx::TypeCode>();
	type_code->name = "pilot.kinematics.Velocity4";
	type_code->type_hash = vnx::Hash64(0x8bb69c60caf044a2ull);
	type_code->code_hash = vnx::Hash64(0x6293cb42d0409017ull);
	type_code->is_native = true;
	type_code->is_class = true;
	type_code->native_size = sizeof(::pilot::kinematics::Velocity4);
	type_code->create_value = []() -> std::shared_ptr<vnx::Value> { return std::make_shared<Velocity4>(); };
...
void write(TypeOutput& out, const ::pilot::kinematics::Velocity4& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = pilot::kinematics::vnx_native_type_code_Velocity4;
		out.write_type_code(type_code);
		vnx::write_class_header<::pilot::kinematics::Velocity4>(out);
	}
