...
const vnx::Hash64 DriveState::VNX_TYPE_HASH(0x6c636e9a007ebcd8ull);
const vnx::Hash64 DriveState::VNX_CODE_HASH(0x51b373caaa6ee5fcull);
...
std::string DriveState::get_type_name() const {
	return "pilot.kinematics.linear.DriveState";
}

const vnx::TypeCode* DriveState::get_type_code() const {
	return pilot::kinematics::linear::vnx_native_type_code_DriveState;
}
...
void DriveState::accept(vnx::Visitor& _visitor) const {
	const vnx::TypeCode* _type_code = pilot::kinematics::linear::vnx_native_type_code_DriveState;
...
void DriveState::write(std::ostream& _out) const {
	_out << "{\"__type\": \"pilot.kinematics.linear.DriveState\"";
...
vnx::Object DriveState::to_object() const {
	vnx::Object _object;
	_object["__type"] = "pilot.kinematics.linear.DriveState";
	_object["time"] = time;
...
std::shared_ptr<vnx::TypeCode> DriveState::static_create_type_code() {
	...
	type_code->name = "pilot.kinematics.linear.DriveState";
	type_code->type_hash = vnx::Hash64(0x6c636e9a007ebcd8ull);
	type_code->code_hash = vnx::Hash64(0x51b373caaa6ee5fcull);
	type_code->is_native = true;
	type_code->is_class = true;
	type_code->native_size = sizeof(::pilot::kinematics::linear::DriveState);
...
void write(TypeOutput& out, const ::pilot::kinematics::linear::DriveState& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = pilot::kinematics::linear::vnx_native_type_code_DriveState;
		out.write_type_code(type_code);
		vnx::write_class_header<::pilot::kinematics::linear::DriveState>(out);
	}
